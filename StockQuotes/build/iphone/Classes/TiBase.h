...
// in simulator we redefine to format for StockQuotes Developer console
...
{\
	NSString * exceptionName = [@"org.stockquotes." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.stockquotes";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIStockQuotesNativeItemNone = -1, 
	UIStockQuotesNativeItemSpinner = -2,
	UIStockQuotesNativeItemProgressBar = -3,
	
	UIStockQuotesNativeItemSlider = -4,
	UIStockQuotesNativeItemSwitch = -5,
	UIStockQuotesNativeItemMultiButton = -6,
	UIStockQuotesNativeItemSegmented = -7,
	
	UIStockQuotesNativeItemTextView = -8,
	UIStockQuotesNativeItemTextField = -9,
	UIStockQuotesNativeItemSearchBar = -10,
	
	UIStockQuotesNativeItemPicker = -11,
	UIStockQuotesNativeItemDatePicker = -12,
	
	UIStockQuotesNativeItemInfoLight = -13,
	UIStockQuotesNativeItemInfoDark = -14,
	
	UIStockQuotesNativeItemDisclosure = -15,
	
	UIStockQuotesNativeItemContactAdd = -16
};
