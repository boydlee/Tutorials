...
// in simulator we redefine to format for Cowboys Developer console
...
{\
	NSString * exceptionName = [@"org.cowboys." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.cowboys";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UICowboysNativeItemNone = -1, 
	UICowboysNativeItemSpinner = -2,
	UICowboysNativeItemProgressBar = -3,
	
	UICowboysNativeItemSlider = -4,
	UICowboysNativeItemSwitch = -5,
	UICowboysNativeItemMultiButton = -6,
	UICowboysNativeItemSegmented = -7,
	
	UICowboysNativeItemTextView = -8,
	UICowboysNativeItemTextField = -9,
	UICowboysNativeItemSearchBar = -10,
	
	UICowboysNativeItemPicker = -11,
	UICowboysNativeItemDatePicker = -12,
	
	UICowboysNativeItemInfoLight = -13,
	UICowboysNativeItemInfoDark = -14,
	
	UICowboysNativeItemDisclosure = -15,
	
	UICowboysNativeItemContactAdd = -16
};
